...
# 🟢 CSS CUSTOMIZADO ALINHADO À ESQUERDA PARA O STREAMLIT NÃO BUGA-LO
st.markdown("""
...
/* Remove a cor de seleção vermelha padrão */
::selection { background: rgba(128,128,128,0.3) !important; color: inherit !important; }

/* Scroll horizontal inteligente em tabelas */
.stMarkdown table {
...
/* ======================================================== */
/* 🌙 PADRÃO DARK MODE (MATANDO O VERMELHO) */
/* ======================================================== */
@media (prefers-color-scheme: dark) {
    /* Focus nas caixas de texto (borda cinza em vez de vermelha) */
    ...
    .stButton > button:focus, div[data-testid="stFormSubmitButton"] > button:focus, .stDownloadButton > button:focus,
    .stButton > button:active, div[data-testid="stFormSubmitButton"] > button:active, .stDownloadButton > button:active {
...
/* ======================================================== */
/* ☀️ PADRÃO LIGHT MODE (MATANDO O VERMELHO) */
/* ======================================================== */
@media (prefers-color-scheme: light) {
    /* Focus nas caixas de texto */
    div[data-baseweb="input"]:focus-within, div[data-baseweb="select"]:focus-within, .stChatInputContainer > div:focus-within {
