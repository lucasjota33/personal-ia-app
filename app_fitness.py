...
# 🟢 NOVA FUNÇÃO: Mensagens Premium (Substitui o st.error e st.success vermelhos/verdes)
...
# --- CSS CUSTOMIZADO COM MATERIAL SYMBOLS ---
st.markdown("""
    ...
    /* 🟢 3. MATA A COR VERMELHA PADRÃO DO STREAMLIT EM CLIQUES E TEXTOS 🟢 */
    ::selection { background: rgba(128,128,128,0.3) !important; color: inherit !important; }
    div[data-testid="stNotification"] { display: none !important; } /* Oculta alertas nativos vermelhos */

    /* 4. PADRONIZAÇÃO ELITE (MODO ESCURO) */
    @media (prefers-color-scheme: dark) {
        .stButton > button, div[data-testid="stFormSubmitButton"] > button, .stDownloadButton > button {
            background-color: #CCCCCC !important; color: #000000 !important; border-radius: 10px !important;
            border: 1px solid #FFFFFF !important; font-weight: 700 !important; width: 100%; transition: all 0.3s;
        }
        ...
        /* Contorno Cinza/Branco nas caixas de texto ao clicar */
        div[data-baseweb="input"]:focus-within, div[data-baseweb="select"]:focus-within, .stChatInputContainer > div:focus-within {
            border-color: #CCCCCC !important; box-shadow: 0 0 0 1px #CCCCCC !important;
        }
        /* Linha embaixo da aba */
    ...
    @media (prefers-color-scheme: light) {
        .stButton > button, div[data-testid="stFormSubmitButton"] > button, .stDownloadButton > button {
            background-color: #1A1A1A !important; color: #FFFFFF !important; border-radius: 10px !important;
            border: 1px solid #333333 !important; font-weight: 600 !important; width: 100%; transition: all 0.3s;
        }
        .stButton > button:hover, .stButton > button:focus, .stButton > button:active { 
            background-color: #333333 !important; color: #FFFFFF !important; border-color: #333333 !important;
        }
        button[data-baseweb="tab"] { color: #888 !important; }
        button[aria-selected="true"] { color: #1A1A1A !important; }
        
        /* Contorno Grafite/Preto nas caixas de texto ao clicar */
        div[data-baseweb="input"]:focus-within, div[data-baseweb="select"]:focus-within, .stChatInputContainer > div:focus-within {
